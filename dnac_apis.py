...
def get_output_command_runner(command, device_name, dnac_jwt_token) -> object:
    """
    ...
    # get task id status
    time.sleep(6)  # wait for a second to receive the file name
    ...
    time.sleep(3)  # wait for two seconds for the file to be ready
